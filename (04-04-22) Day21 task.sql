...
---Left---------------------------
select LEFT('Santhosh kumar',8)
---Len----------------------------
select Len('Santhosh kumar')
...
values(@name)
 ...
 exec sp_insert'Santhosh kumar'

 
 update  [dbo].[tbl_fest]
 set sFullName='Praveen' ,sfullname='Santhosh kumar'
 where sno=104
 go
 select *from [dbo].[tbl_fest]

 delete[dbo].[tbl_fest]
 where sFullName='Santhosh kumar'
